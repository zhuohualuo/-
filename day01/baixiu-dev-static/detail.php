...
$postId=$_GET["postId"];
//获取数据
$sql3="SELECT p.title,p.created,p.views,p.likes,p.content,c.name,u.nickname FROM posts p
LEFT JOIN categories c ON c.id=p.category_id
LEFT JOIN users u ON u.id=p.user_id
WHERE c.id!=1 and p.id={$postId}
";
header("Content-Type:text/html;charset=utf-8");
$arr6=query(connect(),$sql3);
// print_r($arr6);
$postData=$arr6[0];
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div class="article">
                ...
                <div class="meta">
                    <span><?php echo $postData["nickname"] ?></span>
                ...
                <div class="content1"><?php echo $postData["content"] ?></div>
            </div>
            <div class="panel hots">
                <h3>热门推荐</h3>
                <ul>
